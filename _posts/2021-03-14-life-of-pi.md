...
Believe it or not, I actually just manually typed the above digits by heart. Back in the days, I used to be able to recite far more digits, prob close to 100 even. Unfortunately I don't have Sheldon Cooper's eidetic memory, so that's how much stayed in my memories as I grew older. I did a quick lookup online, that's actually a correct recollection! Woohoo!
...
It was dated back to ancient Greece. Pythagoras, who is best known for The Pythagorean theorem[^fn1] in the western world, had claimed all numbers in life can be represented by ratios of (rational) numbers, i.e. are all `rational numbers` as explained in last section.
...
As an engineer, I'm oftentimes amazed yet also baffled by the fact that we have constants, such as speed of light and `pi`, in our real world. That can be a discussion easily leading to religions, or a higher power / designer of the world we're living in. Cuz programmers would know that, when we're feeling lazy, we may just hardcode stuff (or better yet, mark it as a `TODO` too, so it'll stay there until end of time. :D), or how often we just declare a constant:
