...
So what if we're really living in a simulated environment or a giant ant farm that's administered by a higher intelligence, like a `microverse` as described in one of the episodes in [Rick and Morty](https://www.imdb.com/title/tt2861424/)? Or if we're just brains in a vat really?
