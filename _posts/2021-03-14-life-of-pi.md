...
That's so profound. You can actually find your social insurance number, date of birth, in fact, any finite sequence of digits in π's infinite digits, as long as you search further enough[^fn1]. I've found a [website](http://mypiday.com/) that visualizes searches for birthdays in π for you.

You can input your birthday in the format of your choice, for instance, let's say a person was born on December 31, 1999. I just did a search on the website for `19991231`, and it says it's found at `1,012,191-th` digit in π:
