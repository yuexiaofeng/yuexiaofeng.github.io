...
So it begins. Any hand-made stuff that's not produced by AI, now including manually typing all the code for programs from scratch, would essentially become luxuries[^fn1] in future.
