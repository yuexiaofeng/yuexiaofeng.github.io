...
6. I once won (Hu) on the first tile discarded in a Sichuan-style Mahjong 🀅, which is called Earth's Grace. Statistically, the chance is 1 in ~3.2 million. To do a back-of-the-envelope calculation, a game typically takes 10 to 15 minutes, so let's say 5 games per hour on average, give or take. If we played 8 hours straight every single day, for 365 days a year, then this'd happen once in about 219 years, i.e. roughly from when Napoleon crowned himself emperor in 1804, all the way to 2023.
