...
My first name `Xiaofeng` [Sh-OW-f-uh-ng][▷](../assets/heisenberg.gif){:target="_blank"}, is pronounced very similar to SHAW-phone. It came from the combination of two Chinese characters romanized by pinyin (literally means *spelled sounds*). So in this case, it's xiào (4th tone i.e. falling tone) + fēng (1st tone i.e. flat tone) = Xiaofeng.
